...
BlackRoad-enhanced Jenkins automation
...
```bash
# Install
npm install @blackroad-os/blackroad-os-jenkins

# Configure
export BLACKROAD_API_KEY="your-key"

# Run
blackroad-blackroad-os-jenkins start
```
...
|------|-------|-------|---------|
| Starter | $29/mo | 10 | Community |
| Professional | $149/mo | 100 | Priority |
| Enterprise | $745/mo | Unlimited | 24/7 Dedicated |
...
- 🐛 Issues: https://github.com/BlackRoad-OS/blackroad-os-jenkins/issues
