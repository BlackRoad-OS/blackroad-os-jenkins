# Contributing to blackroad-os-jenkins
...
```bash
# Clone your fork
git clone https://github.com/YOUR_USERNAME/blackroad-os-jenkins.git
cd blackroad-os-jenkins

# Add upstream remote
git remote add upstream https://github.com/BlackRoad-OS/blackroad-os-jenkins.git
